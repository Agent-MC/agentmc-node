...
export interface paths {
    ...
    "/teams/agents": {
         ...
         * @description Lists visible agents for the current team. Host API key callers only receive agents assigned to that authenticated host.
         */
...
export interface components {
    schemas: {
        ...
        Notification: {
            ...
            /**
             * @description AgentMC runtime instruction context attached for agent inbox notifications so runtimes can act on a tagged-agent notification without refetching instructions first.
             * @example {
             *       "source": "agentmc_notification",
             *       "intent_scope": "agentmc",
             *       "context_app": "AgentMC",
            ...
            agent_instructions: {
                /**
                 * @description Instruction context source for this notification payload.
                 * @example agentmc_notification
                 */
                source: string;
                /**
                 * @description Canonical AgentMC intent scope for this notification context.
                 * @example agentmc
                 */
                intent_scope: string;
                /**
                 * @description App name associated with the runtime instruction context.
                 * @example AgentMC
                 */
                context_app: string;
                /**
                 * @description Base API URL the runtime should use for AgentMC SDK operations.
                 * @example https://agentmc.ai/api/v1
                 */
                api_base_url: string;
                /**
                 * @description Canonical Node SDK package for AgentMC operations.
                 * @example @agentmc/api
                 */
                sdk_package: string;
                /**
                 * @description Instruction that AgentMC work should run through the SDK rather than raw endpoint calls.
                 * @example sdk_only
                 */
                sdk_mode: string;
                /**
                 * @description Environment variable name for AgentMC API authentication.
                 * @example AGENTMC_API_KEY
                 */
                auth_env: string;
                /**
                 * @description Whether the runtime should expect AgentMC auth to be injected in environment variables.
                 * @example true
                 */
                api_key_runtime_injected: boolean;
                /**
                 * @description Canonical rule for how the runtime should load and use the AgentMC API key.
                 * @example Use process.env.AGENTMC_API_KEY for SDK auth.
                 */
                api_key_usage_rule: string;
                /**
                 * @description Blocking error message to surface when the AgentMC API key is unavailable.
                 * @example AGENTMC_API_KEY is not set in runtime env.
                 */
                missing_api_key_error: string;
                /**
                 * @description High-level instruction about which AgentMC surfaces are the source of truth.
                 * @example Use AgentMC tasks, boards, calendar, notifications, briefs, and files APIs as the source of truth.
                 */
                workflow_hint: string;
                /**
                 * @description High-level instruction for how realtime messaging should be handled.
                 * @example Use AgentMC realtime sessions and type=message signals for chat/files channel traffic.
                 */
                realtime_hint: string;
                /**
                 * @description Acting agent id that should be used for agent-scoped notification follow-up work.
                 * @example 42
                 */
                acting_agent_id: number;
                /**
                 * @description Header name to send when AgentMC calls need explicit acting-agent scope.
                 * @example X-Agent-Id
                 */
                acting_agent_header_name: string;
                /**
                 * @description Header value to send when AgentMC calls need explicit acting-agent scope.
                 * @example 42
                 */
                acting_agent_header_value: number;
                /**
                 * @description Fallback query parameter name for acting-agent scope.
                 * @example agent_id
                 */
                acting_agent_query_name: string;
                /**
                 * @description Fallback query parameter value for acting-agent scope.
                 * @example 42
                 */
                acting_agent_query_value: number;
                /**
                 * @description AgentMC runtime skill instructions that should be prepended for execution context.
                 * @example # AgentMC Skill
                 *     Use the AgentMC Node SDK package `@agentmc/api` as the only source of truth.
                 */
                skill_markdown: string;
                /**
                 * @description Shared team context markdown included with the notification for the acting agent.
                 * @example # Team Context
                 *     Coordinate work in AgentMC.
                 */
                team_markdown: string;
                /**
                 * @description Canonical runtime rules markdown for AgentMC execution behavior.
                 * @example # Runtime Rules
                 *     Never mark a notification read before the response step succeeds.
                 */
