...
Creates one task. Host/team API key callers should send X-Agent-Id (or agent_id query) so actor attribution resolves to the acting agent. Machine callers cannot target personal boards.
